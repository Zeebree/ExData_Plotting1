## Script for creating global active power histogram for the dates 2007-02-01 and 2007-02-02
...
## 4. Make histogram Global Active Power and save it to png file
png(filename="plot1.png", width = 480, height = 480)
hist(plot_data$Global_active_power, xlab = "Global Active Power (kilowatts)", 
